...
const credentials = {
  ...
  redirect_uris: ["https://angelalingan.github.io/meet/"],
  javascript_origins: ["https://angelalingan.github.io", "http://localhost:3000"],
};
...
module.exports.getAccessToken = async (event) => { //a new Lambda function
